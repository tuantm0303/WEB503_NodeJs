...
import { list, read, remove, signin, signout, signup, update } from "../controllers/auth"
...
userRouter.patch('/users/:id/:userId', requireSignin, isAuth, isAdmin, checkAuth, update)
